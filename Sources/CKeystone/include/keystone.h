...
/*  This file has been modified by Jesse in an attempt to get it to import
    into a Swift wrapper */
...
// this is added just so swift can access the (opaque) type
typedef struct ks_struct *ks_engine_opaque_t __attribute__((swift_name("ks_engine")));
...
/*
 Fucking Swift won't import ks_engine no matter what the fuck (else) I do
 So, we do this and create 'dummy.c'
 */
//KEYSTONE_EXPORT
//ks_engine *ks_get_engine_handle_for_swift_only(void);
